...
S pomočjo delitve prostora $R^n$ lahko poiščemo triangulacijo simpleksov. Poiščimo triangulacijo simpleksa $S \in M^n_{\frac{a}{1}}$.
Naj bodo točke $x_i := (0, \dots, 0, a, 0, \dots, 0)$ take točke evklidskega prostora $\R^n$, ki imajo edino neničelno koordinato na $i$-tem mestu enako a. Označimo z $x_0$ točko evklidskega prostora $\R^n$, ki ima vse koordinate enake nič. Konveksna ogrinjača točk $x_0, x_1, \dots, x_n$ je $n$-simpleks $S = \langle x_0, x_1, \dots, x_n \rangle$. Potem je $k$-ta triangulacija simpleksa $S$ simplicialni kompleks, ki vsebuje vse take simplekse iz mrežne triangulacije $M_\frac{a}{k}^n$ prostora $\R^n$, ki so vsebovani v simpleksu $S$. Naj bo $R = <y_0, y_1, \dots, y_n>$ poljuben $n$-simpleks v prostoru $\R^n$. Definirajmo homeomorfno preslikavo $h : S \to R$ s predpisom
