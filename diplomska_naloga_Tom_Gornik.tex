...
% ####################   FUNKCIJA    ####################
	...
	\end{tikzpicture}
	\caption{Skica Bolzanovega izreka}\label{fig:bolzano}
\end{figure}
...
% ####################   3 - D    ####################
	...
	\end{tikzpicture}
	\caption{Na sliki, lahko vidimo, kako smo ozačili posamezno lice kocke. Na levi je kocka $\I$, na sredini kocka $\I^2$, na desni pa je prikazana kocka $\I^3$}
\end{figure}
...
\begin{figure}[h!]
	...
	\end{tikzpicture}
	\caption{Na sliki modre točke predstavljajo točke iz $H_i^+$, rdeče pa točke iz $H_i^-$. Ko se pimpleksi zmanjšujejo, sta točki vedno bližje in zato imata zaporedji teh točk isto limito.}
\end{figure}
